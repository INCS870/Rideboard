		...
		if (role.equals(com.rideboard.common.Constants.TYPE_RACE)) {
			...
			if (racer != null) {
				...
				if (entity != null) {
					...
					logger.info("entity profile name: " + entity.getName());
					logger.info("entity first name: " + entity.getFirstName());
					logger.info("entity mid name: " + entity.getMidName());
					logger.info("entity last name: " + entity.getLastName());
					logger.info("entity ranking: " + entity.getRanking());
				}
			}
